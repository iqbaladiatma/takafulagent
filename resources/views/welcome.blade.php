        ...
        <div class="section-container">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center">
                    <img src="{{ asset('images/takaful-logo.svg') }}" alt="Takaful Keluarga" class="h-10 md:h-12">
                </div>
    ...
    <footer id="kontak" class="bg-gray-900 text-white pt-12 pb-6">
        <div class="section-container">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
                <div>
                    <div class="mb-6">
                        <img src="{{ asset('images/takaful-logo.svg') }}" alt="Takaful Keluarga" class="h-10 mb-3">
                    </div>
